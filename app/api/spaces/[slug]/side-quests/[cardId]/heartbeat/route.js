...
import { getSpaceBySlug, heartbeatSideQuestCard, sideQuestSessionHash } from "../../../../../../../src/server/sideQuests";
...
export async function POST(request, { params }) {
  try {
    ...
    await heartbeatSideQuestCard(supabase, { spaceId: space.id, cardId, sessionHash: sideQuestSessionHash(sessionToken) });
