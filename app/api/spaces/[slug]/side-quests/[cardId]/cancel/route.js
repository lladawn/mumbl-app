...
import { cancelSideQuestCard, getSpaceBySlug, sideQuestSessionHash } from "../../../../../../../src/server/sideQuests";
...
export async function POST(request, { params }) {
  try {
    ...
    await cancelSideQuestCard(supabase, { spaceId: space.id, cardId, sessionHash: sideQuestSessionHash(sessionToken) });
